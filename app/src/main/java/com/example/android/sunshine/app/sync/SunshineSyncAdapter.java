...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter{
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            dayTime = new Time();
            Log.d("Sync","Entries: "  + weatherArray.length());
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                if(i==0) {
                    ...
                    putDataMapReq.getDataMap().putDouble("CURRENT_HIGH", high);
                    putDataMapReq.getDataMap().putDouble("CURRENT_LOW", low);
                    ...
                    Log.d("SyncAdapter", "Watch data set datetime: " + dateTime);
                }
